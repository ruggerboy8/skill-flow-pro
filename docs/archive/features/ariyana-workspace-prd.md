...
in `docs/archive/features/ariyana-coaching-workspace.md`):
...
- `docs/archive/features/ariyana-coaching-workspace.md` — design synthesis of the source conversation (primary research).
- `docs/management-model.md` — G1/G2 (and G7) strategic context; the signal-routing organ.
- `docs/archive/features/facilitator-presentation.md` + `src/pages/facilitate/FacilitatePage.tsx` — adjacent facilitation surface.
...
- `docs/archive/data-model.md`, `docs/archive/glossary.md` — schema conventions and domain terms.
</content>
</invoke>
