> **Archived 2026-08-19 (DOC-5).** This is a historical record, accurate about the past, and is not a description of how the system works today. Do not treat it as current. For the present state see docs/README.md. Specifically wrong: its header claims it is updated at the end of every working session, but it holds one session entry and has not been touched in over five months.
...
silently removed: ~~Living document. Updated at the end of every working
session.~~ Last actually updated 2026-03-06.*
