...
interface FocusBuilderProps {
  roleFilter: number;
}

export function FocusBuilder({ roleFilter }: FocusBuilderProps) {
  ...
  const [selectedRole, setSelectedRole] = useState<number | null>(roleFilter);
