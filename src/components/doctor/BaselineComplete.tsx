  ...
  if (phase === 'reflection') {
    return (
      <div className="max-w-2xl mx-auto space-y-6">
        <Card>
          <CardHeader>
            <CardTitle className="text-lg">One last thing before we wrap up</CardTitle>
          </CardHeader>
    ...
    <div className="max-w-2xl mx-auto space-y-6">
      <Card className="text-center">
        ...
        <CardContent className="space-y-6">
          <div className="bg-muted/50 rounded-lg p-4 text-sm text-muted-foreground leading-relaxed space-y-2 text-left">
            <p>
              Great work getting through that. I'll review everything and reach out to schedule your baseline check-in conversation.
            </p>
            <p>
