-- Fix the bulk_upsert_pro_moves function to properly match competencies by role
...
BEGIN
  ...
  LOOP
    BEGIN
      ...
      -- Get competency_id from competency_name AND role_id (FIXED: now filters by role)
