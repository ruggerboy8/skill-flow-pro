-- Create RPC function to get staff domain averages for individual results
...
BEGIN
  ...
  agg AS (
    ...
    FROM items i
    GROUP BY staff_id, domain_id, domain_name
  )
  SELECT
    bs.staff_id,
    bs.staff_name,
...
-- Create RPC function to get competency breakdown for staff domain drawer
