-- Remove hire_date filter from get_staff_all_weekly_scores to show all historical data
-- The hire_date filter should only be in view_staff_submission_windows for accountability
