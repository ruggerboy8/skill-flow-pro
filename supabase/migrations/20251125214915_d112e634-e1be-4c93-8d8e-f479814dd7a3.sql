-- Fix get_staff_all_weekly_scores to include locked assignments
-- The status filter was preventing any data from showing because all assignments are 'locked'
