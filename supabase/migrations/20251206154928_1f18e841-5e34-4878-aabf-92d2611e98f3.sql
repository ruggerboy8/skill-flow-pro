...
-- Drop all overloads of get_staff_weekly_scores to start fresh
DROP FUNCTION IF EXISTS public.get_staff_weekly_scores(uuid);
...
-- Recreate with a single clean signature using TEXT for flexibility
