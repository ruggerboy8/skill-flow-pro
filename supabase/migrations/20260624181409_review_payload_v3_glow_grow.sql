...
-- Applied version: 20260624181409

-- Phase 2 P0: extend the staff review payload to carry per-competency Glow/Grow.
-- Additive and conservative: bumping the version to 3 means any cached v2 payload
-- is recomputed on next view; the only new content is observer_glow/observer_grow
-- on each candidate item. All ranking/sparse logic is unchanged from v2.
